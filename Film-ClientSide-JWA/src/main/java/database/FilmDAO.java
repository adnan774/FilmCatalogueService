...
public class FilmDAO {
    ...
    Statement stmt = null;
	String user = "pateladn";
    String password = "jeRgphal2";
   ...
   /**
	...
	public ArrayList<Film> searchFilms(String option, String searchStr) {
	    ...
	    // Create select statement and execute it
		try{
		    String selectSQL = "select * from films WHERE "+option+" LIKE '%"+searchStr+"%';";
		    System.out.println(selectSQL);
		    ResultSet rs1 = stmt.executeQuery(selectSQL);
	    // Retrieve the results
		    while(rs1.next()){
		    	oneFilm = getNextFilm(rs1);
		    	filmSearch.add(oneFilm);
		    }
